...
Repository: `KG-NINJA/HerculesKabu10`.
...
Existing CI/deployment definitions: `.github/workflows/charts.yml`, `.github/workflows/ci.yml`, `.github/workflows/daily_prediction.yml`. Inspect applicable triggers before push/merge. A workflow filename alone does not prove a deploy target or successful deployment.
